...
function engineerQs(baseAnswer) {
    inquirer.prompt ([
        {
            type: 'input',
            name: 'answerGithub',
        ...
        const newEngineer = new Engineer(baseAnswers.answerName, baseAnswers.answerId, baseAnswer.answerEmail, answer.answerGithub);
        teamArr.push(newEngineer);
        if(answer.answerAddAnother === true) {
            employeeQs();
        }else{
            buildTeam();
